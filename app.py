...
elements = {
    "Δομικά Χαρακτηριστικά": {
        ...
        "opt4": "Η ΑΛΟΥΜΥΛ έχει αυστηρούς κανόνες και διαδικασίες. Οι επίσημες διαδικασίες καθορίζουν γενικά τις ενέργειες των ανθρώπων.",
    },
    "Ηγεσία Οργανισμού": {
    ...
    "Συνοχή Οργανισμού": {
        "opt1": "Αυτό που κρατά την ΑΛΟΥΜΥΛ ενωμένη είναι η αφοσίωση και η εμπιστοσύνη μεταξύ των ανθρώπων. Η αφοσίωση στην εταιρεία είναι υψηλή.",
        "opt2": "Αυτό που κρατά την ΑΛΟΥΜΥΛ ενωμένη είναι η αφοσίωση για προσέλκυση νέων ιδεών και ανάπτυξη. Στοχεύουμε να είμαστε μπροστά από τους άλλους.",
        "opt3": "Αυτό που κρατά την ΑΛΟΥΜΥΛ ενωμένη είναι η επιτυχία και η επίτευξη στόχων.",
        "opt4": "Αυτό που κρατά την ΑΛΟΥΜΥΛ ενωμένη είναι οι κανόνες και οι διαδικασίες, ώστε όλα να λειτουργούν ομαλά.",
    },
    "Στρατηγικές Προτεραιότητες": {
        "opt1": "Η ΑΛΟΥΜΥΛ δίνει έμφαση στην ανάπτυξη των ανθρώπων. Υπάρχει εμπιστοσύνη, ανοιχτή επικοινωνία και συνεργασία.",
        "opt2": "Η ΑΛΟΥΜΥΛ δίνει έμφαση στην απόκτηση νέων πόρων και τη δημιουργία νέων προκλήσεων. Η δοκιμή νέων πραγμάτων και η αναζήτηση ευκαιριών εκτιμώνται ιδιαίτερα.",
        "opt3": "Η ΑΛΟΥΜΥΛ δίνει έμφαση στις ανταγωνιστικές ενέργειες και τα επιτεύγματα. Η επίτευξη των φιλόδοξων στόχων και η επικράτηση στην αγορά είναι πρωταρχικής σημασίας.",
        "opt4": "Η ΑΛΟΥΜΥΛ δίνει έμφαση στη μονιμότητα και τη σταθερότητα. Η αποτελεσματικότητα, ο έλεγχος και η ομαλή λειτουργία είναι σημαντικά.",
    },
    "Κριτήρια Επιτυχίας": {
        "opt1": "Η ΑΛΟΥΜΥΛ ορίζει την επιτυχία με βάση την ανάπτυξη και το ενδιαφέρον για τους ανθρώπους της, την ομαδική εργασία και την αφοσίωση των εργαζομένων της.",
        "opt2": "Η ΑΛΟΥΜΥΛ ορίζει την επιτυχία με βάση το να κατέχει τα πιο μοναδικά ή νέα προϊόντα της αγοράς. Είναι ηγέτης και καινοτομεί στον τομέα των προϊόντων.",
        "opt3": "Η ΑΛΟΥΜΥΛ ορίζει την επιτυχία με βάση το μερίδιο που κατέχει στην αγορά και την υπεροχή έναντι του ανταγωνισμού. Η ανταγωνιστική της θέση στην αγορά είναι ύψιστης σημασίας.",
        "opt4": "Η ΑΛΟΥΜΥΛ ορίζει την επιτυχία με βάση την αποτελεσματικότητα. Η αξιόπιστη παράδοση, ο καλός προγραμματισμός και η χαμηλού κόστους παραγωγή είναι κρίσιμης σημασίας.",
    },
}
...
st.sidebar.selectbox("Γενιά", generations, key="generation", index=None, placeholder="Επιλέξτε Γενιά...",
